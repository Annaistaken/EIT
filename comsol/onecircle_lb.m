...
% onecircle_test.m
%
% Model exported on May 14 2020, 13:37 by COMSOL 5.4.0.225.
...
model.component('comp1').geom('geom1').feature('c1').set('pos', {'-0.7' '-0.4'});
model.component('comp1').geom('geom1').feature('c1').set('r', '0.2');
model.component('comp1').geom('geom1').run('c1');
% model.component('comp1').geom('geom1').move({'c1'}, [0.2 0]);
model.component('comp1').geom('geom1').feature('c1').set('pos', {'-0.5' '-0.4'});
model.component('comp1').geom('geom1').run('c1');
% model.component('comp1').geom('geom1').move({'c1'}, [0 -0.1]);
model.component('comp1').geom('geom1').feature('c1').set('pos', {'-0.5' '-0.5'});
model.component('comp1').geom('geom1').run('c1');
...
model.component('comp1').material('mat3').propertyGroup('def').set('electricconductivity', {'2'});
...
for i = 1:8 
    for j = i+1:8
        ...
        model.result.export('plot1').set('filename', [ 'D:\\Proj\\EIT\\comsol\\data\\lb', num2str(n), '.csv' ]);
