...
% Untitled.m
%
% Model exported on May 14 2020, 13:09 by COMSOL 5.4.0.225.
...
for i = 1:8 
    for j = i+1:8
        ...
        model.result.export('plot1').set('filename', [ 'D:\\Proj\\EIT\\comsol\\data\\refe', num2str(n), '.csv' ]);
